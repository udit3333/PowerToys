...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT messageCode, WPARAM wParam, LPARAM lParam)
{
    ...
    // Create main window
    case WM_CREATE:
        child_window_handle = CreateWindowEx(0, L"ChildWClass", NULL, WS_CHILD | WS_BORDER, 0, 0, 0, 0, hWnd, NULL, module_handle, NULL);
        return 0;
    ...
    case WM_SIZE:
        ...
        MoveWindow(child_window_handle, 200, 200, 400, 500, TRUE);
...
DWORD WINAPI ThreadProc(LPVOID lpParam)
{
    ...
    windowClass.hInstance = module_handle;
    ...
    window_handle = CreateWindowEx(0, L"InjectedDLLWindowClass", pString, WS_EX_PALETTEWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 400, 300, prnt_hWnd, hMenu, module_handle, NULL);
    */
...
const static wchar_t* MODULE_NAME = L"RunExecutable";
// Add a description that will we shown in the module settings page.
const static wchar_t* MODULE_DESC = L"<Damn!!>";
...
class RunExecutable : public PowertoyModuleIface
{
private:
    // The PowerToy state.
...
public:
    ...
    {
        init_settings();
        RegisterHotKey(nullptr, 1, MOD_ALT, 0x4E);
    };
    ...
    virtual intptr_t signal_event(const wchar_t* name, intptr_t data) override
    {
        if (wcscmp(name, ll_keyboard) == 0)
        {
            ...
            {
                // ShellExecute(nullptr, L"open", L"C:\\Users\\udsing\\source\\repos\\PowerToys\\PowerToyTemplate.sln", NULL, NULL, SW_SHOWNORMAL);
                return 1;
            }
                else
                {
...
void RunExecutable::init_settings()
{
    try
    {
        // Load and parse the settings file for this PowerToy.
        PowerToysSettings::PowerToyValues settings =
            PowerToysSettings::PowerToyValues::load_from_settings_file(RunExecutable::get_name());
